...
PROPERTY_TYPE_LANDING_LABELS = {
    ...
    'townhouse': {'ru': 'Дома', 'en': 'Townhouses', 'th': 'ทาวน์เฮาส์'},
...
def _build_ru_paragraphs(signature: LandingSignature, property_type_label: str, district_label: str, location_label: str) -> List[str]:
    ...
    type_focus = {
        ...
        '': 'В каталоге Undersun Estate собраны актуальные предложения по продаже и аренде недвижимости на Пхукете: виллы, квартиры, дома и земельные участки.',
    }
