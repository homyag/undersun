...
- `translate_text(text, target_language, preserve_html=False)` - Translate text using configured API
  ...
  - **Dependencies**: Yandex Translate API, HTML processing
...
The TranslationService class provides automated content translation capabilities using the Yandex Translate API.
