...
- `translate_text(text, target_language, preserve_html=False)` - Перевести текст используя настроенный API
  ...
  - **Зависимости**: Yandex Translate API, обработка HTML
...
Класс TranslationService предоставляет возможности автоматизированного перевода контента через Yandex Translate API.
